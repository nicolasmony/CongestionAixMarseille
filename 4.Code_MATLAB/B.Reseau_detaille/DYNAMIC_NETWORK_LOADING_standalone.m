...
N_jam = 5.5 * link.capacity .* link.FFT_mod;      % (used later in loop) PREVIOUSLY 4
...
tnw = round(4.5 * link.FFT_mod / dt);             % num of time-steps for shockwave to propagate to tail node % PREVIOUSLY 3
